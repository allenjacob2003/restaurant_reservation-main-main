        ...
        <div>
            <div className='flex justify-center items-center min-h-screen bg-gray-100'>
                <div className='bg-white p-8 rounded-lg shadow-md w-96 px-8 py-6 w-full max-w-md'>
                    <h1 className='text-2xl font-bold text-center text-gray-800 mb-4'>User Login</h1>
                    <form onSubmit={OnsubmitHandler}>
                        ...
                        <div className='mb-4'>
                            <p className='text-sm font-semibold text-gray-600 mb-2'>Doesn't have an account? <a onClick={() => { navigate('/signup') }} className='text-blue'>Signup</a></p>
                        </div>
                    </form>
                </div>
            </div>
